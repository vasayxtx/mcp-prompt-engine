...
// Note: it's an almost copy-paste of the original mcptest package from github.com/mark3labs/mcp-go.
// Will be removed when https://github.com/mark3labs/mcp-go/pull/346 is merged.
